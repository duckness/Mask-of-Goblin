<template>
  <b-field id="star-selector-field" :custom-class="size">
    <p class="control">
      <button class="button is-static" :class="iconClass">★</button>
    </p>
    <b-select id="star-selector-input" v-model="star" :size="size" expanded v-bind="$attrs" @focus="scrollHandler()">
